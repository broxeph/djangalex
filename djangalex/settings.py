...
if DEBUG:
    ...
    # Uploaded media lives on S3 under media/ and is served straight from the bucket
    ...
    STORAGES = {
        'default': {'BACKEND': 'storages.backends.s3.S3Storage', 'OPTIONS': {'location': MEDIA_LOCATION}},
